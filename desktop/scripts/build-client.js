...
const BUILD_DIR_NAME = 'build-desktop';
...
console.log('Сборка клиента для десктопа...');
...
fs.cpSync(CLIENT_BUILD_DIR, RENDERER_DIR, { recursive: true });
console.log('Скопировано в', RENDERER_DIR);
