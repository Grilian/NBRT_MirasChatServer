      ...
      <aside className="app-menu-drawer" aria-label="Меню приложения" onMouseDown={(event) => event.stopPropagation()}>
        <div className="app-menu-profile">
          ...
          <div className="app-menu-profile-text">
            ...
            <button type="button" className="app-menu-status" onClick={() => run(onOpenStatus)}>
              <span className="app-menu-status-label">Статус:</span>
              <span>{ownStatus ? `${ownStatus.emoji} ${ownStatus.label}` : 'Сменить статус'}</span>
            </button>
          </div>
        ...
        <div className="app-menu-items">
          ...
          <button type="button" className="app-menu-item" onClick={() => planned('Звонки')}>
            <span className="app-menu-item-icon is-calls">{icon('M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2 4.2 2 2 0 0 1 2-2h3a2 2 0 0 1 2 1.7c.1.9.4 1.8.7 2.6a2 2 0 0 1-.4 2.1L8.1 9.6a16 16 0 0 0 6 6l1.2-1.2a2 2 0 0 1 2.1-.4c.8.3 1.7.6 2.6.7a2 2 0 0 1 1.7 2Z')}</span>
          ...
          <label className="app-menu-item app-menu-theme">
            <span className="app-menu-item-icon is-theme">
