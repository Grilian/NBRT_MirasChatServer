...
import CalendarWidget, { CalendarOpenTarget } from './CalendarWidget';
import { SectionMeta } from '@/app/NavRail';
...
const CalendarSection: React.FC<CalendarSectionProps> = ({ onBack, changeToken, openTarget, onOpenTargetHandled }) => (
  <CalendarWidget
    onBack={onBack}
