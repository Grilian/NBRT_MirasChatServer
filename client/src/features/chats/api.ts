...
/**
 * Очистить переписку. Только личная переписка и «Дневник»: в группе и общем чате
...
// рядом в списке жил личный чат, и звезда «в избранное» читалась как отправка
// туда, а не как закрепление строки.
