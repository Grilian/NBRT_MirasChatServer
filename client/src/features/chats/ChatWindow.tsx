...
import { closeMobileInputSurface } from '@/shared/platform/mobileKeyboard';
import { CustomEmojiMap, renderMessageText, renderTextWithEmoji, toPlainText } from '@/features/emoji/customEmoji';
...
const ChatWindow: React.FC<ChatWindowProps> = ({
  ...
  // оставаться видимой, иначе открыть её можно было бы только наугад через меню.
  const isGroupChat = Boolean(chatId && /^group_\d+$/.test(chatId));
                    ...
                    {msg.document_path && (
                      ...
                      >
                        ...
                        <span className="bubble-file-body">
                          <FileName name={msg.document_name} className="bubble-file-name" />
