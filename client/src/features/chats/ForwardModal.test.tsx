...
vi.mock('@/shared/hooks/autoFocus', () => ({ AUTOFOCUS_ON_OPEN: false }));
...
test('окно пересылки берёт штатный режим клавиатуры и отдаёт его при закрытии', () => {
  ...
  // и заданная в фабрике vi.mock она бы не дожила до запуска.
  (acquireStandardKeyboardResizeMode as Mock).mockReturnValue(mockRelease);
