...
В Настройках всё это отражается строками «Загрузка обновления» и «Обновление X встанет при закрытии». Кнопка там одна и необязательная — «Перезапустить», для тех, кто не хочет ждать. Текущая версия показана там же, рядом: без неё сообщение о доступном обновлении не с чем сравнить.
